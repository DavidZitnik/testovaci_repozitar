...
print(line)
text_number = input("Enter a number btw. 1 and 3 to select:")           # vyber textu
print(line)
...
There are {numbers_count} lowercase words.
...
print(line)
for radek in graph:
    print(f'{radek[0]:>3}|{radek[1]:<{max_size + 2}}|{len(radek[1])}')
